...
public partial class SettingsWindow:Window
{
 ...
 static readonly HashSet<string> MultiOpenableKeys=new(StringComparer.OrdinalIgnoreCase){"Note","Todo","MapFolder","Managed","QuickNote","Music","Clock","Weather","Tags","SystemMonitor","Countdown","Launcher","WorkTimer"};
