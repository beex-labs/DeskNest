...
public partial class SettingsWindow:Window
{
 ...
 void Changed(object? s,RoutedEventArgs e)
 {
  ...
  // When switching themes, if the global text color remains set to the default value of the previous theme, it automatically reverts to the current theme’s default color (dark → white, others → dark blue), ensuring that text in input fields and content remains readable regardless of the theme.
 ...
 /// <summary>BeeX Data Catalog: View, Open, Modify, and Migrate Entirely. </summary>
 ...
 void ChangeBeeXRoot_Click(object s,RoutedEventArgs e)
 {
  ...
  // Use an empty folder directly; if the destination already contains other files, automatically append a BeeX subdirectory, and display the final actual path in a confirmation dialog box.
 ...
 void RestartApp()
 {
  ...
  // First exit the process, then have the shell delay the restart to prevent the new instance from triggering the "already running" check.
 ...
 /// <summary> Screenshot and Screen Recording Settings Page: Open the Screen Recording Output Folder </summary>
 ...
 /// <summary>Default multi-select reminders for new to-dos: Applies only to to-dos created after this change </summary>
 ...
 /// <summary>Shared Grid Background: Select an image, copy it to the "backgrounds" folder in the BeeX data directory, and then apply it to all grids</summary>
 ...
 /// <summary>About page author section: GitHub logo + name button (Content is a panel; Localization.Apply does not overwrite it); clicking it opens </summary> in the system browser.
