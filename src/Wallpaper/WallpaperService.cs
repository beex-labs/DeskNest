...
/// and power state. It rebuilds surfaces when the display layout changes, pauses on lock, and re-attaches when the
/// shell restarts.
/// </summary>
public sealed class WallpaperService : IDisposable
{
    ...
    void BuildWindows()
    {
        foreach (var screen in Forms.Screen.AllScreens)
        {
            ...
            window.Show();
            window.AttachToDesktop(clickThrough: !item.Interactive);
